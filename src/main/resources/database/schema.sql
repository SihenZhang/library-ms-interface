...
CREATE TABLE `book`  (
  ...
  `book_author` varchar(100) NULL DEFAULT NULL COMMENT '书籍作者',
...
CREATE TABLE `category`  (
  ...
  `cat_pid` int UNSIGNED NULL DEFAULT NULL COMMENT '父级分类 id',
  `cat_level` tinyint NULL DEFAULT NULL COMMENT '分类等级',
...
CREATE TABLE `lease`  (
  ...
  `book_id` int UNSIGNED NOT NULL COMMENT '借阅图书 id',
...
CREATE TABLE `student`  (
  ...
  `stu_age` smallint NOT NULL COMMENT '学生年龄',
